      ...
      <div className="max-w-2xl mx-auto space-y-8">
        ...
        >
          ...
          <div className="p-8 bg-slate-50 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
            ...
            <a className="bg-green-500 text-white px-6 py-2.5 rounded-xl font-bold flex items-center gap-2 hover:bg-green-600 transition-all shadow-lg shadow-green-500/20 text-sm" href="https://wa.link/lr24ph" target="_blank" rel="noopener noreferrer">
              Chat Admin
            </a>
          </div>
        </motion.div>
